...
public class TrainLocationUpdateController {
	...
	public @ResponseBody Map<String,Object> activeUpdateTrainLocation(HttpServletResponse response, HttpServletRequest request, 
	...
	public @ResponseBody Map<String,Object> passiveUpdateTrainLocation(HttpServletResponse response, HttpServletRequest request, 
