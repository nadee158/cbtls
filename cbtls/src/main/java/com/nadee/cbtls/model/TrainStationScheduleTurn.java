...
@Table(name = "train_station_schedule_turn", uniqueConstraints =@UniqueConstraint(columnNames = {"train_station_schedule_turn_id"}))
public class TrainStationScheduleTurn implements Serializable {
	...
	public TrainScheduleTurn getTrainTurn() {
		return trainScheduleTurn;
	}

	public void setTrainTurn(TrainScheduleTurn trainScheduleTurn) {
